...
//alert(baseURL);
  ...
  var appFormInfoValidator = appFormInfo.validate({
    ...
    submitHandler: function (form) {
      hitURL = baseURL + "ajax/review-form-check.php",
  ...
  var identityFormInfo = $('#identity_form');
  var appFormInfoValidator = identityFormInfo.validate({
    errorClass: "invalid",
    debug: true,
    highlight: function (element) {
      $(element).addClass("c1");
  ...
  var court_verifFormInfo = $('#court_verif_form');
  var appFormInfoValidator = court_verifFormInfo.validate({
    errorClass: "invalid",
    debug: true,
    highlight: function (element) {
      $(element).addClass("c1");
  ...
  var drug_verifFormInfo = $('#drug_verif_form');
  var appFormInfoValidator = drug_verifFormInfo.validate({
    errorClass: "invalid",
    debug: true,
    highlight: function (element) {
      $(element).addClass("c1");
  ...
  var gcbFormInfo = $('#gcb_form');
  var appFormInfoValidator = gcbFormInfo.validate({
    errorClass: "invalid",
    debug: true,
    highlight: function (element) {
      $(element).addClass("c1");
  ...
  var appFormInfoValidator = ssnFormInfo.validate({
    errorClass: "invalid",
    debug: true,
    highlight: function (element) {
      $(element).addClass("c1");
  ...
  var criminalFormInfo = $('#criminal_form');
  var appFormInfoValidator = criminalFormInfo.validate({
    errorClass: "invalid",
    debug: true,
    highlight: function (element) {
      $(element).addClass("c1");
  ...
  var gsFormInfo = $('#gs_form');
  var appFormInfoValidator = gsFormInfo.validate({
    errorClass: "invalid",
    debug: true,
    highlight: function (element) {
      $(element).addClass("c1");
  ...
  var appFormInfoValidator = nsrFormInfo.validate({
    errorClass: "invalid",
    debug: true,
    highlight: function (element) {
      $(element).addClass("c1");
  ...
  var appFormInfoValidator = comp_verifFormInfo.validate({
    errorClass: "invalid",
    debug: true,
    highlight: function (element) {
      $(element).addClass("c1");
