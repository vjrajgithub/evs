  ...
  <div class="pcoded-inner-content">
    <div class="main-body">
      <div class="page-wrapper">
        ...
        <h5 class="page_header_top">Verification Check Details</h5>
                    ...
                    <div class="portlet-body"><!-- 
                      ...
                      <div class="table-container">
                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                          ...
                          <tbody>
                            <?php
                            $sql_query = "SELECT tp . * , ep . * FROM `tbl_application` tp, employee_personal_info_tbl ep WHERE tp.application_ref_id = ep.application_id   order by tp.id DESC";
                            ...
                            if (mysqli_num_rows($result) > 0) {
                              while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                if (in_array($row['application_status'], ['3', '4', '5', '6', '7'])) {
                                  ?>
                                  <tr style="display: table-row;">
                                    ...
                                    $type_of_check_array = $row['type_of_check'];
...
$type_of_verification = get_type_of_verification_case_allocate($mycon, $row['application_ref_id'], $user_id);

$type_of_check_array = $type_of_verification;

}

?>
                                    <?php getTypeOfCheckName($mycon, explode(',', $type_of_check_array)); ?>
                                    <td><?php echo $row['case_id']; ?></td>
                                    <td><?php echo $row['case_record_date']; ?></td>
                                    <td><?php echo getApplicationStatus($row['application_status'],$mycon) ?></td>

                                    <td>
                                      <a href="<?php echo baseUrl() . "application-view-check.php?appid=" . $row['application_ref_id'] ?>" title="view"><i class="fa fa-eye" aria-hidden="true" ></i>
                                      </a>
      <!--                                    <a href="<?php echo baseUrl() . "add-application-verification.php?appid=" . $row['application_ref_id'] ?>" title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true" ></i>
                                      </a>-->
                                      <?php
                                      if (in_array($row['application_status'], ['3', '4', '5', '6', '7'])) {
                                        ?>
                                        <a href="<?php echo baseUrl() . "add-application-verification.php?appid=" . $row['application_ref_id'] ?>"  title="Check Information" ><i class="fa fa-plus-square-o" aria-hidden="true"></i> </a>


                                                                                                                                                                                                                  <!--                                    <a href="#" title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true" data-toggle="modal" data-target=".bd-example-modal-lg_edit"></i></a>

                                                                                                                                                                                                                                                      <a href="#" title="Add Information" ><i class="fa fa-plus-square-o" aria-hidden="true" data-toggle="modal" data-target=".bd-example-modal-lg_edit"></i> </a>-->
                                        <!-- <a href="#" title="Delete" onclick="deleteApplicationCheck('<?php // echo $row['application_ref_id']; ?>')"><i class="fa fa-trash-o" aria-hidden="true"></i> </a> -->
                                      <?php } ?>
                                      <?php // if ($userRole == 10 || $userRole == 11 || $userRole == 12) { ?>
                                      <?php if (in_array($row['application_status'], ['9', '10', '8', '6', '7'])) { ?>
                                      <a href="<?php echo baseUrl() . "form-data-review-check.php?appid=" . $row['application_ref_id'] ?>"  title="form data review (raise a query for insuff)" ><i class="fa fa-check-square-o" style="font-size:18px;" aria-hidden="true"></i> </a>
                                      <?php  } ?>
                                      <?php // } ?>
...
<div class="modal fade bd-example-modal-lg_view12 modal_views_app" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="myModalbody">
      ...
      <div class="vertical_tabs_views">
        <div class="tabordion">
          <section id="section1">
            ...
            <label class="labls" for="option15">Application Details Document
            </label>
            <article>
...
<div class="modal fade bd-example-modal-lg_edit modal_views_app show" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" id="myModalbody">
  <div class="modal-dialog modal-lg">
    <div class="modal-header">
      <!-- <h4 class="modal-title" id="myLargeModalLabel">Large modal</h4> -->
      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
    ...
    <div class="modal-content">
      ...
      <div id="demo">
        <div class="step-app">
          <ul class="step-steps">
            <li class="active"><a href="#tab1">Application Details</a></li>
          ...
          <div class="step-content">
            <div class="step-tab-panel active" id="tab1">
            ...
            <div class="step-tab-panel" id="tab2">
              ...
              <form name="frmInfo" id="frmInfo" novalidate="novalidate">
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
            ...
            <div class="step-tab-panel" id="tab4">
              ...
              <form name="frmLogin" id="frmLogin" novalidate="novalidate">
                <div>
                  ...
                  <div class="vertical_tabs_views">
                    <div class="tabordion">
                      <section id="section123">
                        <input type="radio" name="sections" id="option123" checked="">
                        <label class="labls" for="option123">High School (10th)
                        </label>
                        <article>
                          <div class="row">
                      ...
                      <section id="section231">
                        <input type="radio" name="sections" id="option231">
                        <label class="labls" for="option231">Intermediate (12th)
                        </label>
                        <article>
                          <div class="row">
                      ...
                      <section id="section321">
                        <input type="radio" name="sections" id="option321">
                        <label class="labls" for="option321">Degree Graduation
                        </label>
                        <article>
                          <div class="row">
                      ...
                      <section id="section432">
                        <input type="radio" name="sections" id="option432">
                        <label class="labls" for="option432">Post Graduation</label>
                        <article>
                      ...
                      <section id="section543">
                        <input type="radio" name="sections" id="option543">
                        <label class="labls" for="option543">If Any Other Qualification </label>
                        <article>
                  ...
                  <div class="col-md-6">
                    <table class="table">
                      ...
                      <tr>
                        ...
                        <td>:</td>
                        <td>Keas 69 Str.15234, Chalandri Athens, Greece</td>
                      </tr>
                    </table>
                  </div>
                  <div class="col-md-6">
        ...
        <!--   <a class="extra-fields-customer" href="#">Add More Employer <span class="fa fa-plus-circle"></span>
          </a> -->
                </div>
            ...
            <div class="step-tab-panel" id="tab6">
              ...
              <form name="frmMobile" id="frmMobile" novalidate="novalidate">
                <div class="row">
                  <div class="col-md-6">
                    <table class="table">
                      <tr>
    ...
    <!--  <span aria-required="true" class="required"> * </span> --></label> <div><input type="text" name="name" data-required="1" class="form-control"></div></div> <div class="form-group"><label class="control-label">Street No / Road / Lane
      <!-- <span aria-required="true" class="required"> * </span> --></label> <div><input type="text" name="name" data-required="1" class="form-control"></div></div>
          ...
          <div class="step-footer">
            <button data-direction="prev" class="step-btn" style="display: none;">Previous</button>
            <button data-direction="save" class="step-btn">Save</button>
            <button data-direction="next" class="step-btn">Next</button>
            <button data-direction="finish" class="step-btn" style="display: none;">Finish</button>
          </div>
        </div>
      </div>
...
<!--********* modal popup end html code   *********-->



<!--********* modal popup start for add_info html code *********-->

<div class="modal fade bd-example-modal-lg_add_infor modal_views_app" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="myModalbody">
  <div class="modal-dialog modal-lg">
    <div class="modal-header">
      <!-- <h4 class="modal-title" id="myLargeModalLabel">Large modal</h4> -->
      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
<!--********* modal popup for add_infor end html code -->
