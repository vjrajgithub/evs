                     ...
                     <div id="demo">
                        <div class="step-app">
                           <ul class="step-steps">
                              ...
                              <li <?php echo is_visble_verification_tab(10, $type_of_verification_array); ?>  class="active"><a href="edit-cibil.php?appid=<?php echo $app_id; ?>">CIBIL Details</a></li>
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div>
                                             <input type="text" name="pancard_no" value="<?php echo $appInformation['cibilData'][0]['pancard_no'] ?>" id="pancard_no" placeholder="Enter Pancard Number" data-required="1" class="form-control">
                                          </div>
                                       </div>
                                       <!-- <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                       ...
                                       <div class="form-group">
                                          ...
                                          <h6 <?php echo ($appInformation['cibilData']['0']['is_completed'] != '1') ? "style='color:red'" : "style='color:green'" ?>><?php echo $appInformation['cibilData']['0']['review_comment']; ?></h6>
                                       </div>
