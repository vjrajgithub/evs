        ...
        <div class="main-body">
            <div class="page-wrapper">
                <div class="page-body">
                    ...
                    <li class="active" <?php echo is_visble_verification_tab(19, $type_of_verification_array); ?>><a href="edit-national_sex_registry.php?appid=<?php echo $app_id; ?>">National Sex Offender Registry (NSO)</a></li>
                    <li <?php echo is_visble_verification_tab(20, $type_of_verification_array); ?>><a href="edit-company_verifaction.php?appid=<?php echo $app_id; ?>">Company Verification</a></li>
                                    ...
                                    <div class="step-tab-panel" id="tab2">
                                        <h3 class="employer_one">National Sex Offender Registry (NSO)</h3>
                                        <!--<form method="post" id="personalForm" enctype="multipart/form-data">-->
                                        <form method="post" id="frmInfo_national_sex_registry" enctype="multipart/form-data">
                                            <input type="hidden" name="form_type" value="nsr">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <?php $sql = "select * from employee_national_sex_registry where application_id =  '" . $app_id . "'";
                                       ...
                                       <span aria-required="true" class="required"> * </span></label>  -->
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <h6 <?php echo ($appInformation['nsrData'][0]['is_completed'] != '1') ? "style='color:red'" : "style='color:green'" ?>><?php echo $appInformation['nsrData']['0']['review_comment']; ?></h6>
                                                    </div>
                                                </div>
