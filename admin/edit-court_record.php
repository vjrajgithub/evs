        ...
        <div class="main-body">
            <div class="page-wrapper">
                <div class="page-body">
                    ...
                    <li class="active" <?php echo is_visble_verification_tab(11, $type_of_verification_array); ?>><a href="edit-court_record.php?appid=<?php echo $app_id; ?>">Court Records Check</a></li>
                    ...
                    <li <?php echo is_visble_verification_tab(20, $type_of_verification_array); ?>><a href="edit-company_verifaction.php?appid=<?php echo $app_id; ?>">Company Verification</a></li>
                                    ...
                                    <div class="step-tab-panel" id="tab2">
                                        ...
                                        <form method="post" id="frmInfo_court_rec" enctype="multipart/form-data">
                                            <input type="hidden" name="form_type" value="court_rec">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <?php $sql = "select * from employee_court_record where application_id =  '" . $app_id . "'";
                                       ...
                                       <span aria-required="true" class="required"> * </span></label>  -->
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <h6 <?php echo ($appInformation['courtData'][0]['is_completed'] != '1') ? "style='color:red'" : "style='color:green'" ?>><?php echo $appInformation['courtData']['0']['review_comment']; ?></h6>
                                                    </div>
                                                </div>
