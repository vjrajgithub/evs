               ...
               <div class="card">
                  <div class="card-block application_dtls">
                     <div id="demo">
                        <div class="step-app">
                           <ul class="step-steps">
                              <li><a href="add-new-applications.php" class="active">Application Details</a></li>
                              ...
                              <li <?php echo is_visble_verification_tab(7, $type_of_verification_array); ?> class="active"><a href="reference.php">Reference Details</a></li>
                           ...
                           <div class="step-tab-panel" id="tab7">
                              ...
                              <form name="reference_form" id="reference_form" autocomplete="false">
                                             ...
                                             <div class="row">
                                                <div class="col-md-6">
                                                   <div class="form-group">
                                                      ...
                                                      <div>
                                                         <input type="text" autocomplete="off" value="<?php echo $appInformation['referenceData']['0']['name'] ?>" name="name_pr1" id="name_pr1" data-required="1" class="form-control">
                                                      </div>
                                                   </div>
                                                   <div class="form-group">
                                                      ...
                                                      <div>
                                                         <input type="number" autocomplete="off" name="phone_pr1" value="<?php echo $appInformation['referenceData']['0']['phone_no'] ?>" id="phone_pr1" data-required="1" class="form-control">
                                                      </div>
                                                   </div>
                                                   <div class="form-group">
                                                      <label class="control-label">Company/Organisation
                                                      </label>
                                                      <div>
                                                         <input type="text" autocomplete="off" name="company_pr2" value="<?php echo $appInformation['referenceData']['1']['organization_name'] ?>" id="company_pr2" data-required="1" class="form-control">
                                                      </div>
                                                   </div>
                                                   <div class="form-group">
                                                      ...
                                                      <!-- city -->
                                                      <input type="text" autocomplete="off" name="city_pr1" value="<?php echo $appInformation['referenceData']['0']['city']; ?>" id="city_pr1" placeholder="Enter city" data-required="1" class="form-control">
                                                   ...
                                                   <div class="form-group">
                                                      ...
                                                      <div>
                                                         <input type="number" name="pincode_pr1" id="pincode_pr1" value="<?php echo $appInformation['referenceData']['0']['pin_code'] ?>" data-required="1" class="form-control">
                                                      </div>
                                                   </div>
                                                </div>
                                                <div class="col-md-6">
                                                   <div class="form-group">
                                                      ...
                                                      <div>
                                                         <input type="email" autocomplete="off" name="email_pr1" value="<?php echo $appInformation['referenceData']['0']['email_address'] ?>" id="email_pr1" data-required="1" class="form-control">
                                                      </div>
                                                   </div>
                                                   <div class="form-group">
                                                   ...
                                                   <div class="form-group">
                                                      ...
                                                      <div>
                                                         <input type="text" name="designation_pr2" value="<?php echo $appInformation['referenceData']['1']['designation'] ?>" id="designation_pr2" data-required="1" class="form-control">
                                                      </div>
                                                   </div>
                                                   <div class="form-group">
                                             ...
                                             <div class="row">
                                                <div class="col-md-6">
                                                   ...
                                                   <div class="form-group">
                                                      ...
                                                      <div>
                                                         <input type="text" name="company_pr2" value="<?php echo $appInformation['referenceData']['1']['organization_name'] ?>" id="company_pr2" data-required="1" class="form-control">
                                                      </div>
                                                   </div>
                                                   <div class="form-group">
                                                      <label class="input_hdr" for="City">City</label>
                                                      <!-- <select name="city_pr2" id="city_pr2" class="form-control">
                                                         ...
                                                         foreach ($cities as $city) {
                                                            $selected = "";
                                                            if ($city['city_name'] == $appInformation['referenceData']['1']['city']) {
                                                               $selected = " selected ";
                                                            }
                                                         ?>
                                                ...
                                                <div class="col-md-6">
                                                   ...
                                                   <div class="form-group">
                                                      ...
                                                      <!-- <select name="city_perr1" id="city_perr1" class="form-control">
                                                         ...
                                                         foreach ($cities as $city) {
                                                            $selected = "";
                                                            if ($city['city_name'] == $appInformation['referenceData']['2']['city']) {
                                                               $selected = " selected ";
                                                            }
                                                         ?>
                                                            <option <?php echo $selected ?> value="<?php echo $city['city_name']; ?>"><?php echo $city['city_name'] ?></option>
...
<script>
   ...
   //    change_country('country_pr1', 'state_pr1', 'city_pr1');
   //    change_country('country_pr2', 'state_pr2', 'city_pr2');
   //    change_country('country_perr1', 'state_perr1', 'city_perr1');
   //    change_country('country_perr2', 'state_perr2', 'city_perr2');

   //    change_state('state_pr1', 'city_pr1');
   //    change_state('state_pr2', 'city_pr2');
   //    change_state('state_perr1', 'city_perr1');
   //    change_state('state_perr2', 'city_perr2');
