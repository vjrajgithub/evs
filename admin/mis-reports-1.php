  ...
  <div class="pcoded-inner-content">
    <div class="main-body">
      <div class="page-wrapper">
        <h5 class="page_header_top">MIS Report 1</h5>
          ...
          <div class="tabs">
            ...
            <div class="tab">
              ...
              <div class="tab-content">
                ...
                <form action="report_mis_1.php" onsubmit="submitForm()" method="POST" style="display: flex; justify-content: center; align-items: center;">
                  <div class="form-group">
                    ...
                    <div class="portlet-body"><!-- 
                      ...
                      <div class="table-container">
                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                          ...
                          <tbody>
                            <?php
                            $sql_query = "SELECT tp . * , ep . * FROM `tbl_application` tp, employee_personal_info_tbl ep WHERE tp.application_ref_id = ep.application_id ".$role_item."".$srcitem." order by tp.id DESC";
                            ...
                            if (mysqli_num_rows($result) > 0) {
                              while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                <tr style="display: table-row;" class="<?php echo $row['application_ref_id']; ?>">
                                  ...
                                  <td>
                                  <a href="<?php echo baseUrl() . "mis_view.php?appid=" . $row['application_ref_id'] ?>" title="view"><i class="fa fa-eye" aria-hidden="true" ></i></a>
                                  </td>
                                </tr>
                                <?php
                              }
