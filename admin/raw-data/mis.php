<?php
$dataAbout = "Employee with 100% Knowledge in MIS";
...
<form action="report-mis.php" onsubmit="submitForm()" method="POST" style="display: flex;justify-content: center;text-align: center;">
