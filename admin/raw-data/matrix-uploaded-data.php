...
if($delete != ''){ 
	...
	$sql = "DELETE FROM tbl_emp_dept_matrix WHERE id=".$delete."";
...
if($file_refNo != ''){ $file_refNum = "AND fileRefno = ".$file_refNo; } else { $file_refNum = ''; }

if($_POST['fileRefno'] != ''){ $srcitem = "AND fileRefno = ".$_POST['fileRefno']; } else { $srcitem = ''; }
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-md-12" style="margin-top: 23px;">
                                      <h2 style="font-size: 14px;font-weight: bold;text-align: center;color: #282A2C;">
                                        Matrix Uploaded File Data
                                      </h2>
                                    </div>
                                    ...
                                    <div class="portlet light portlet-fit portlet-datatable bordered">
                                        <div class="portlet-title">
                                            ...
                                            <div class="col-md-2">
                                                <a class="back_up"  href="matrix-uploaded-file.php" style="background-color: #63B54F;color: #fff;padding: 5px 10px;text-decoration: none;">Back
                                                </a>
                                                <div id="header">
                                                    <div id="menu">
                                    ...
                                    <div id="home" class="portlet-body ">
                                            ...
                                            <div class="tabs">
                                                <div class="tab">
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" onsubmit="submitForm()" method="POST" style="display: flex; align-items: center;justify-content: center;">
                                                            ...
                                                            <div class="buttons">
                                                                <button class="btn btn-primary" onclick="validateme('msg');" style="background-color:#63B54F; border-color: #63B54F;max-width: 132px;width: 100%; margin-left: 5px; margin-top: -16px;" type="submit">Advance Search</button>
                                                ...
                                                <div class="tab">
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <form action="" onsubmit="submitForm()" method="POST" style="display: flex; align-items: center;justify-content: center;">
                                                            <div class="form-group">
                                        ...
                                        <div class="table-container matrix_data_table">
                                            ...
                                            <table class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="sample_3" role="grid" aria-describedby="sample_3_info" style="width:100%;" class="display responsive" >
                                                <thead>
                                                    <tr role="row">
                                                        <th >Emp Code</th>
                                                        <th>Location</th>
                                                        ...
                                                        <th >Inward <br />Segregation <br />Process</th>
                                                        ...
                                                        <th >PIV <br />Floor <br />Process
                                                        </th>
                                                        <th >PIV <br />System <br />Process</th>
                                                        <th >W/H <br />Adminstration <br />Process</th>
                                                ...
                                                <tbody>
                                                <?php if($_POST['item'] != ''){
												$sql_query = "SELECT * FROM `tbl_emp_dept_matrix` WHERE created_at !='' ".$srcitem." ".$srcfrom." ".$file_refNum." order by id DESC";
												
											   } else {
												$sql_query = "SELECT * FROM `tbl_emp_dept_matrix` WHERE created_at !='' ".$file_refNum." order by id DESC";
											   }
												 ...
												 $i = 1; 
                                                   ...
                                                   ?>  
                                                    <tr>
													  ...
													  <td><?php echo $row['inward_document_checking_process']; ?></td>  
													  <td><?php echo $row['inward_vehicle_unloading_process']; ?></td>  
													  <td><?php echo $row['inward_floor_planning']; ?></td>  
													  <td><?php echo $row['inward_segregation_rocess']; ?></td>
													  <td><?php echo $row['inward_system_process']; ?></td>  
													  <td><?php echo $row['uc_floor_process']; ?></td>  
													  <td><?php echo $row['uc_system_process']; ?></td>  
													  <td><?php echo $row['binning_system_process']; ?></td>
													  <td><?php echo $row['inventory_handling_process_audit']; ?></td>
													  <td><?php echo $row['outward_system_process']; ?></td>  
													  <td><?php echo $row['picking_process']; ?></td>  
													  <td><?php echo $row['packing_process']; ?></td>  
													  <td><?php echo $row['dispatch_process']; ?></td>  
													  <td><?php echo $row['dispatch_document_checking_process']; ?></td>
                                                      <td><?php echo $row['piv_floor_process']; ?></td>
													  <td><?php echo $row['piv_system_process']; ?></td>  
													  <td><?php echo $row['wh_adminstration_process']; ?></td>  
													  <td><?php echo $row['mis']; ?></td>  
													  <td><?php echo $row['updatedDate']; ?></td>  
													  <td><?php echo $row['fileRefno']; ?></td>
                                                      <td><a onclick="return confirm('Are you sure?')" href="matrix-uploaded-data.php?delete=<?php echo $row['id']; ?>&file_refNum=<?php echo $file_refNo; ?>"><span data-tooltip="" title="" class="cursor" data-tooltip-id="0"><i class="fa fa-trash" aria-hidden="true" style="color:orange; font-size:17px;    margin-left: 12px; font-weight:bold;"></i></span></a></td>
                                                    </tr>
													<?php $i++; } } ?>
                                                </tbody>
                                            </table>
