...
if ($_POST['item'] != '') {
  ...
  $sql2 = "SELECT tm . *, tu . * FROM tbl_users tu, tbl_emp_dept_matrix tm WHERE tu.emp_code = tm.emp_id AND
        tm.dispatch_document_checking_process = 100 " . $role_item . " AND tu.isDeleted != 1 AND tu.roleId IN (2, 3, 4, 13, 14)
...
$file = "Employee-with-100-percent-Knowledge-in-DISPATCH-DOCUMENT-CHECKING-PROCESS-" . $dated . ".xls";
