<?php
$dataAbout = "Employee with 100% Knowledge in Inventory Handling Process";
...
function get_all_no_of_rows($mycon, $srcitem, $srcfrom, $role_item) {
  $sql_query = "SELECT tu . *, tm.emp_id, tm.cust_code, tm.loc_code  FROM tbl_users tu, tbl_emp_dept_matrix tm WHERE tu.emp_code = tm.emp_id AND
    tm.inventory_handling_process_audit = 100
...
<form action="report-inventory-handling-process-audit.php" onsubmit="submitForm()" method="POST" style="display: flex;justify-content: center;text-align: center;">
