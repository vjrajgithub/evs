                ...
                <div class="page-sidebar-wrapper">
                    ...
                    <div class="page-content-wrapper">
                        ...
                        <div class="page-content">
                            ...
                            <div class="row">
                                <h2 style="font-size: 14px;font-weight: bold;text-align: center;color: #282A2C;margin-top: 48px;">Knowledge Of Multiple Customer</h2>
                                <div class="col-md-12">
                                    ...
                                    <div id="home" class="portlet-body ">
                                            ...
                                            <div class="tabs">
                                                ...
                                                <div class="tab">
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <form class="download_excel" action="knowledge-of-multiple-customer-report.php" method="POST">
                                                            <div class="form-group">
                                                                <select class="Select_Items form-control" id="sel1" name="item">
                                                                    <option value="">--All Customers--</option>
                                                                    <?php
                                        ...
                                        <div class="table-container matrix_data_table">
                                            <p class="details_table">
                                                ...
                                                <?php } else { ?>
                                                  <span><b>Searched values : </b> <?php echo get_Customer($mycon, $_POST['item']); ?></span> | <strong>Total Search Data: </strong><span><?php echo get_all_no_of_rows($mycon, $srcitem, $srcfrom, $role_item); ?></span> | <span><b>Total No. of data :</b> <?php echo get_total_no_of_rows($mycon, $srcitem, $srcfrom, $role_item); ?></span>
                                                <?php } ?>
                                            </p>
                                            <table class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="sample_3" role="grid" aria-describedby="sample_3_info" style="width: 100%;">
                                                <thead>
                                                    <tr role="row">
                                                        <th class="sorting_asc" tabindex="0" aria-controls="sample_3" rowspan="1" colspan="1" style="width: 60px;" aria-sort="ascending" aria-label="Emp Id : activate to sort column descending">Emp Code
                                                        </th>
                                                        ...
                                                        if (mysqli_num_rows($result_loc) > 0) {
                                                          ...
                                                          while ($rowloc = mysqli_fetch_assoc($result_loc)) {
                                                            ...
                                                            //die('hellooo');
                                                            ?>
                                                            <th class="sorting" tabindex="0" aria-controls="sample_3" rowspan="1" colspan="1" style="width: 87px;"> <?php echo "Customer<br />Name-<br />" . $rowloc['client']; ?> <br /> <?php echo "/ Customer <br />Code-<br />" . $rowloc['client_code']; ?> </th>
                                                        ...
                                                        <th class="sorting" tabindex="0" aria-controls="sample_3" rowspan="1" colspan="1" style="width: 82px;" aria-label="% of Knowledge: activate to sort column ascending">% of <br />Location <br />Knowledge<br />/ ( Total <br />Customer - <br /><?php echo $tol_loc; ?>)</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    ...
                                                    if (mysqli_num_rows($result) > 0) {
                                                      while ($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        // $name = get_name($mycon, $row['emp_id']);
                                                        // $designation = get_designation($mycon, $row['emp_id']);
                                                        // $department = get_department($mycon, $row['emp_id']);
                                                        ...
                                                        <tr style="display: table-row;" role="row" class="odd">
                                                            ...
                                                            if (mysqli_num_rows($result_loc1) > 0) {
                                                              ...
                                                              while ($rowloc1 = mysqli_fetch_assoc($result_loc1)) {
                                                                $sql_query_loc2 = "SELECT * FROM `tbl_emp_dept_matrix` WHERE cust_code = '" . $rowloc1['id'] . "' AND emp_id = '" . $row['emp_code'] . "'";
                                                                $result_loc2 = mysqli_query($mycon, $sql_query_loc2);
                                                                //echo "<pre>"; echo $sql_query_loc2;
...
//  echo "<br/>".$count_of_percent."<br/>green --".$i."<br/>All --".$k;
                                                    ?>
                                                </tbody>
                                            </table>
                                        </div>
