...
<?php include 'sidebar.php'; ?>
                    ...
                    <div class="page-content-wrapper">
                        ...
                        <div class="page-content">
                            ...
                            <div class="row">
                                <h2 style="font-size: 14px;font-weight: bold;text-align: center;color: #282A2C;margin-top: 48px;">Employee with 0 % Knowledge</h2>
                                <div class="col-md-12">
                                            ...
                                            <div class="tabs">
                                                ...
                                                <div class="tab">
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <form action="report-zero-percent-knowledge.php" onsubmit="submitForm()" method="POST" style="display: flex;justify-content: center;text-align: center;">
                                                            <div class="form-group">
                                        ...
                                        <div class="table-container matrix_data_table">
                                            <table class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="sample_3" role="grid" aria-describedby="sample_3_info" style="width:100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    tm.wh_adminstration_process = 0 AND
                                                    tm.mis = 0
