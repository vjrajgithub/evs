...
if ($userdata['role'] == 2 || $userdata['role'] == 3) {
  ...
  $role_item = " AND tu.organization_id  = '" . $user_location . "'";
} else {
  $role_item = '';
}
...
function get_all_no_of_rows($mycon, $srcitem, $srcfrom, $role_item) {
  $sql_query = "SELECT * FROM tbl_users as tu WHERE isDeleted != 1 AND roleId IN (2, 3, 4, 13, 14) " . $srcitem . " " . $srcfrom . " " . $role_item . " order by name DESC";
...
function get_total_no_of_rows($mycon, $srcitem, $srcfrom, $role_item) {
  $sql_query = "SELECT * FROM tbl_users as tu WHERE isDeleted != 1 AND roleId IN (2, 3, 4, 13, 14) ";
  $result = mysqli_query($mycon, $sql_query);
  return mysqli_num_rows($result);
}
?>
                ...
                <div class="page-sidebar-wrapper">
                    ...
                    <div class="page-content-wrapper">
                        ...
                        <div class="page-content">
                            ...
                            <div class="row">
                                <h2 style="font-size: 14px;font-weight: bold;text-align: center;color: #282A2C;margin-top: 48px;">Employee Data</h2>
                                <div class="col-md-12">
                                            ...
                                            <div class="tabs">
                                                ...
                                                <div class="tab">
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <form action="report-total-employee.php" onsubmit="submitForm()" method="POST" style="display: flex;justify-content: center;text-align: center;">
                                                            <div class="form-group">
                                            ...
                                            <table class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="sample_3" role="grid" aria-describedby="sample_3_info" style="width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    if ($_POST['item'] != '') {
                                                      ...
                                                      $sql_query = "SELECT * FROM tbl_users as tu WHERE isDeleted != 1 AND roleId IN (2, 3, 4, 13, 14) " . $role_item . " order by name DESC LIMIT 0, 20";
                                                    }
                                                    // echo $sql_query."<br />item--".$_POST['item']."<br />srcitem--".$srcitem."<br />colunmData--".$_POST['colunmData'];
                                                    $result = mysqli_query($mycon, $sql_query);
                                                    if (mysqli_num_rows($result) > 0) {
                                                      while ($row = mysqli_fetch_assoc($result)) {
