<?php
$dataAbout = "Employee with 100% Knowledge in OUTWARD UC SYSTEM PROCESS";
...
<form action="report-uc-system-process.php" onsubmit="submitForm()" method="POST" style="display: flex;justify-content: center;text-align: center;">
