                ...
                <div class="page-sidebar-wrapper">
                    ...
                    <div class="page-content-wrapper">
                        ...
                        <div class="page-content">
                            ...
                            <div class="row">
                                <h2 style="font-size: 14px;font-weight: bold;text-align: center;color: #282A2C;margin-top: 48px;">Employee with 50 % Knowledge</h2>
                                <div class="col-md-12">
                                            ...
                                            <div class="tabs">
                                                <div class="tab">
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" onsubmit="submitForm()" method="POST" style="display: flex;justify-content: center;text-align: center;">
                                                ...
                                                <div class="tab">
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <form action="report-fifty-percent-knowledge.php" onsubmit="submitForm()" method="POST" style="display: flex;justify-content: center;text-align: center;">
                                                            <div class="form-group">
                                        ...
                                        <div class="table-container matrix_data_table">
                                            <table class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="sample_3" role="grid" aria-describedby="sample_3_info" style="width:100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    tm.inward_document_checking_process = 50 AND
                                                    tm.inward_vehicle_unloading_process = 50 AND
                                                    tm.inward_floor_planning = 50 AND
                                                    tm.inward_segregation_rocess = 50 AND
                                                    tm.inward_system_process = 50 AND
                                                    tm.uc_floor_process = 50 AND
                                                    tm.uc_system_process = 50 AND
                                                    tm.binning_system_process = 50 AND
                                                    tm.inventory_handling_process_audit = 50 AND
                                                    tm.outward_system_process = 50 AND
                                                    tm.picking_process = 50 AND
                                                    tm.packing_process = 50 AND
                                                    tm.dispatch_process = 50 AND
                                                    tm.dispatch_document_checking_process = 50 AND
                                                    tm.piv_floor_process = 50 AND
                                                    tm.piv_system_process = 50 AND
                                                    tm.wh_adminstration_process = 50 AND
                                                    tm.mis = 50
                                                    ...
                                                    tm.wh_adminstration_process = 50 AND
                                                    tm.mis = 50
                                                    " . $role_item . " AND tu.isDeleted != 1 AND tu.roleId IN (2, 3, 4, 13, 14) group by tm.emp_id order by tu.name LIMIT 0, 20";
                                                    }
