...
//session_start();
$dataAbout = "EMPLOYEE WITH 100% KNOWLEDGE IN PACKING PROCESS";
...
$file = "Employee-with-100-percent-Knowledge-in-PACKING-PROCESS-" . $dated . ".xls";
