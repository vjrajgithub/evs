                ...
                <div class="page-sidebar-wrapper">
                    ...
                    <div class="page-content-wrapper">
                        ...
                        <div class="page-content">
                            ...
                            <div class="row">
                                <h2 style="font-size: 14px;font-weight: bold;text-align: center;color: #282A2C;margin-top: 48px;">Location Wise Department Knowledge</h2>
                                <div class="col-md-12">
                                            ...
                                            <div class="tabs">
                                                ...
                                                <div class="tab">
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <form class="download_excel" action="location-wise-matrix-data-report.php" method="POST" >
                                                            <div class="form-group">
                                                                <select class="Select_Items form-control" id="sel1" name="item">
                                                                    <option value="">--All WH Location--</option>
                                                                    <?php
