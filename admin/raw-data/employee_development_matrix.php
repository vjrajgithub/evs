...
function get_all_no_of_rows($mycon, $srcitem, $srcfrom, $role_item) {
  $sql_query = "SELECT tm . *, tu . * FROM tbl_users tu, tbl_emp_dept_matrix tm WHERE tu.emp_code = tm.emp_id  "
                ...
                <div class="page-sidebar-wrapper">
                    ...
                    <div class="page-content-wrapper">
                        ...
                        <div class="page-content">
                            ...
                            <div class="row">
                                <h2 style="font-size: 14px;font-weight: bold;text-align: center;color: #282A2C;margin-top: 48px;">TOTAL MANPOWER IN THE EMPLOYEE DEVELOPMENT Matrix</h2>
                                <div class="col-md-12">
                                            ...
                                            <div class="tabs">
                                                ...
                                                <div class="tab">
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <form action="report-employee-development-metrix.php" onsubmit="submitForm()" method="POST" style="display: flex;justify-content: center;text-align: center;">
                                                            <div class="form-group">
