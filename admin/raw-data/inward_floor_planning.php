<?php
$dataAbout = "Employee with 100% Knowledge in Inward Floor Planning";
...
<form action="report-inward-floor-planning.php" onsubmit="submitForm()" method="POST" style="display: flex;justify-content: center;text-align: center;">
