                                    ...
                                    <div id="home" class="portlet-body ">
                                        ...
                                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" style="display: flex;justify-content: center;text-align: center;">
										   <div class="form-group">
                                            <select class="Select_Items form-control" id="sel1" name="item" required>
                                    ...
                                    <span class="validity"></span>
                                     ...
                                     <!--Advance search form End *-->
                                        <div class="table-container matrix_data_table">
                                           ...
                                           <?php
											   if($_POST['item'] != ''){
												$sql_query = "SELECT * FROM `tbl_emp_dept_matrix` WHERE cust_code != 0 AND loc_code != 0 ".$srcitem." ".$srcemp." ".$srcfrom." Order By id DESC";
                                              ...
                                              if (mysqli_num_rows($result) > 0) {   
		                                        while ($row = mysqli_fetch_assoc($result)) {
                                                   //echo mysqli_num_rows($result);
												                ...
												                $loc_name = get_loc_name($mycon, $row['emp_id']);
																$customer = get_Customer($mycon, $row['emp_id']);
												                 ?>  
