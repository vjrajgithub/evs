<?php
$dataAbout = "Employee with 100% Knowled In W/H ADMINSTRATION PROCESS";
...
<form action="report-wh-adminstration-process.php" onsubmit="submitForm()" method="POST" style="display: flex;justify-content: center;text-align: center;">
