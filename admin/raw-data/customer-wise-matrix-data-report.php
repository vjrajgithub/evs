...
if ($_POST['item'] !== '') {
  $srcitem = "AND cust_code = " . $_POST['item'];
} else {
  $srcitem = '';
}
...
// Merge Columns for showing 'Matrix's Data' start---------------
  ...
  $objPHPExcel->getActiveSheet()
          ->getCell('A1')
          ->setValue("Customer Wise Department Knowledge Report");
  ...
  $objPHPExcel->getActiveSheet()->getStyle('A1:AA1')->applyFromArray($styleArray_header);
...
//$objPHPExcel->getActiveSheet()->getColumnDimension('A2:X2')->setAutoSize(true);
  ...
  $file = "Customer-wise-department-knowledge-report-" . $dated . ".xls";
