...
//session_start();
$dataAbout = "Employee with 100 percent Knowledge in INWARD VEHICLE UNLOADING PROCESS";
...
$file = "Employee-with-100-percent-Knowledge-in-INWARD-VEHICLE-UNLOADING-PROCESS-" . $dated . ".xls";
