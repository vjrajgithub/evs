...
$objPHPExcel->getActiveSheet()
 ->getCell('A1')
 ->setValue("EMPLOYEE WITH 50% KNOWLEDGE IN ALL DEPARTMENT");
...
if($_POST['item'] != ''){
    ...
    $sql2 = "SELECT tm . *, tu . * FROM tbl_users tu, tbl_emp_dept_matrix tm WHERE tu.emp_code = tm.emp_id AND
        ...
        tm.piv_system_process = 50 AND
        tm.wh_adminstration_process = 50 AND
        tm.mis = 50".$role_item." AND tu.isDeleted != 1 AND tu.roleId IN (2, 3, 4, 13, 14)
...
$file = "Employee-with-Fifty-percent-Knowledge-in-ALL-DEPARTMENT-" .$dated. ".xls";
