                                            ...
                                            <div class="tabs">
                                                ...
                                                <div class="tab">
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <form action="report-all-department-knowledge.php" onsubmit="submitForm()" method="POST" style="display: flex;justify-content: center;text-align: center;">
                                                            <div class="form-group">
