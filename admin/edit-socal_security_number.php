        ...
        <div class="main-body">
            <div class="page-wrapper">
                <div class="page-body">
                    ...
                    <li class="active" <?php echo is_visble_verification_tab(16, $type_of_verification_array); ?>><a href="edit-socal_security_number.php?appid=<?php echo $app_id; ?>">Social Security Number (SSN) Verification</a></li>
                    ...
                    <li <?php echo is_visble_verification_tab(20, $type_of_verification_array); ?>><a href="edit-company_verifaction.php?appid=<?php echo $app_id; ?>">Company Verification</a></li>
                                    ...
                                    <div class="step-tab-panel" id="tab2">
                                        ...
                                        <form method="post" id="frmInfo_ssn" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <?php $sql = "select * from employee_socal_security_number where application_id =  '" . $app_id . "'";
...
<!-- ssn no field -->
                                 <div class="form-group">
                                          <label class="control-label  input_hdr">Social Security Number </label>
                                          <div>
                                             <input type="text" name="ss_no" id="ss_no"  data-required="1" required="required" placeholder="" class="form-control">
                                          </div>
                                       </div>
...
<!--end  ssn no field -->
                                       ...
                                       <span aria-required="true" class="required"> * </span></label>  -->
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <h6 <?php echo ($appInformation['ssnData'][0]['is_completed'] != '1') ? "style='color:red'" : "style='color:green'" ?>><?php echo $appInformation['ssnData']['0']['review_comment']; ?></h6>
                                                    </div>
                                                </div>
