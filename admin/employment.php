                     ...
                     <div id="demo">
                        <div class="step-app">
                           <ul class="step-steps">
                              ...
                              <li <?php echo is_visble_verification_tab(8, $type_of_verification_array); ?> class="active"><a href="employment.php">Employment Details</a></li>
                           ...
                           <div class="wrapper">
                                       ...
                                       <div class="row">
                                          <div class="col-md-6">
                                             <div class="form-group">
                                                ...
                                                <div>
                                                   <input type="text" name="employer_name[]" id="employer_name1" value="<?php echo $appInformation['empData']['0']['employer_name'] ?>" data-required="1" class="form-control" placehoder="Please Enter employer name">
                                                </div>
                                             </div>
                                             <div class="form-group">
                                                <label class="control-label">
                                                ...
                                                <div><span class="form-group Date-range">
                                                   ...
                                                   <input type="date"  value="<?php echo $appInformation['empData']['0']['date_of_joining'] ?>"  id="fromdt1" name="fromdt[]" pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}"> <span class="validity"></span></span> <span class="form-group Date-range">
                                                   <label for="bday"> To :</label>
                                                   <input type="date" id="todt1" value="<?php echo $appInformation['empData']['0']['date_of_relieving'] ?>" name="todt[]" pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}"> <span class="validity"></span></span>
                                                </div>
                                             </div>
                                             <div class="form-group">
                                                <label class="control-label">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div>
                                                   <input type="text" name="position[]" id="position" value="<?php echo $appInformation['empData']['0']['designation'] ?>" data-required="1" class="form-control">
                                                </div>
                                             </div>
                                             <div class="form-group">
                                                <label for="select">Department</label>
                                                <div>
                                                   <input type="text" name="department[]" id="position" value="<?php echo $appInformation['empData']['0']['department'] ?>"  data-required="1" class="form-control">
                                                </div>
                                             </div>
                                             <div class="form-group">
                                                ...
                                                <div>
                                                   <input type="text" name="reason_for_Leaving[]" id="reason_for_Leaving1" value="<?php echo $appInformation['empData']['0']['reason_for_leaving'] ?>" data-required="1" class="form-control">
                                                </div>
                                             </div>
                                          ...
                                          <div class="col-md-6">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div>
                                                   <input type="text" name="salary[]" id="salary" value="<?php echo $appInformation['empData']['0']['salary'] ?>" data-required="1" class="form-control">
                                                </div>
                                             </div>
                                             <div class="form-group">
                                                <label class="control-label">
                                                ...
                                                <div>
                                                   <input type="text" name="reporting_manager_name[]" id="reporting_manager_name1" data-required="1" value="<?php echo $appInformation['empData']['0']['reporting_mngr_name'] ?>" class="form-control">
                                                </div>
                                             </div>
                                             <div class="form-group">
                                                <label class="control-label">
                                                   Reporting Person Email Id
                                                   <!-- <span aria-required="true" class="required"> * </span> -->
                                                </label>
                                                <div>
                              ...
                              <div class="buttons">
                                 ...
                                 <button class="remove" onclick="myFunction()">remove</button>
                                 <script>
                                    function myFunction() {
