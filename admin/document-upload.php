                        ...
                        <div class="pcoded-inner-content">
                            <div class="main-body">
                                <div class="page-wrapper">
                                    <h5 class="page_header_top">Document Upload</h5>
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                                            ...
                                            <tbody>
                                                <tr style="display: table-row;">
                                                    ...
                                                    <td>Pending OUT </td>
                                                     <td>
                                                        <a href="#" title="view"  data-toggle="modal" data-target=".bd-example-modal-lg_view12"><i class="fa fa-eye" aria-hidden="true"></i>
                                                        </a>
                                                        <a href="#" title="Edit" data-toggle="modal" data-target=".bd-example-modal-lg"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                                       
                                                          <a href="upload-documnet.php" title="Upload document"><i class="fa fa-upload" aria-hidden="true"></i> </a>
                    ...
                    <div class="modal fade bd-example-modal-lg modal_views_app" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="myModalbody">
                             <div class="modal-dialog modal-lg">
                                ...
                                <div class="modal-content">
                                 ...
                                 <div class="vertical_tabs_views">
                                    <div class="tabordion">
                            <section id="section111">
                                            <input type="radio" name="sections" id="option111" checked>
                                <label class="labls" for="option111">High School (10th)
                            </label>
                         <article>
                        ...
                        <div class="form-group">
                                ...
                                <div class="form-group">
                                 ...
                                 <section id="section222">
                                        <input type="radio" name="sections" id="option222">
                                        <label class="labls" for="option222">Intermediate (12th) 
                                        </label>
                                <article>
                              ...
                              <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        ...
                                        <section id="section333">
                                             <input type="radio" name="sections" id="option333">
                                                <label class="labls" for="option333">Degree Graduation
                                                </label>
                                        <article>
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                     ...
                                     <section id="section444">
                                        <input type="radio" name="sections" id="option444">
                                        <label class="labls" for="option444">Post Graduation</label>
                                         <article>
                                ...
                                <section id="section555">
                             <input type="radio" name="sections" id="option555">
                                    <label class="labls" for="option555">If Any Other Qualification</label>
                                <article>
                             ...
                             <div class="form-group">
                              ...
                              <h3 class="employer_one">Employer Details</h3>
                                <!--  form employment end -->
                                 ...
                                 <div class="vertical_tabs_views">
                                    <div class="tabordion">
                                        <section id="section686">
                                         <input type="radio" name="sections" id="option686" checked="">
                                            <label class="labls" for="option686">Professional Reference-1
                                            </label>
                                                <article>
                                        ...
                                        <section id="section786">
                                            <input type="radio" name="sections" id="option786">
                                            <label class="labls" for="option786">
                                        ...
                                        <section id="section888">
                                             <input type="radio" name="sections" id="option888">
                                                <label class="labls" for="option888">
                                         ...
                                         <section id="section999">
                                            <input type="radio" name="sections" id="option999">
                                            <label class="labls" for="option999">  Personal Reference-2</label>
                                             <article>
