                     ...
                     <div id="demo">
                        <div class="step-app">
                           <ul class="step-steps">
                              ...
                              <li class="active" <?php echo is_visble_verification_tab(16, $type_of_verification_array); ?>><a href="socal_security_number.php">Social Security Number (SSN) Verification</a></li>
                                    ...
                                    <div class="col-md-6">
                                       ...
                                       <div class="form-group">
                                          ...
                                          <select name="doc_type" class="form-control">
                                             ...
                                             <option value="driver_licence">Driver Licence</o ption>
