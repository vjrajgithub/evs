                        ...
                        <ul class="nav-right">
                            <li class="header-notification">
                                <div class="dropdown-primary dropdown">
                                    <?php
										$locNm = get_client_name($mycon, $userdata['client_id']);
										if ($locNm != '') {
										  $locName = $locNm;
										} else {
										  $locName = 'Himadi';
										}
										echo "<strong>Last Login: </strong>" . $userdata['login_time'];
										?>   
                                </div>
                            </li>
							<li class="header-notification">
                                    ...
                                    <ul class="show-notification notification-view dropdown-menu" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                        ...
                                        <li>
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <h5 class="notification-user">Vikas </h5>
                                        ...
                                        <li>
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <h5 class="notification-user">Vijay</h5>
                                                    <p class="notification-msg">Lorem ipsum dolor sit amet, consectetuer elit.</p>
                                                    <span class="notification-time">30 minutes ago</span>
                                                </div>
                                            </div>
                            ...
                            <li class="user-profile header-notification">
                                <div class="dropdown-primary dropdown">
                                    <div class="dropdown-toggle" data-toggle="dropdown">
                                        <img src="upload/user-profile/<?php
										if ($userdata['avatar'] != '') {
										  $avatar_image = $userdata['avatar'];
										} else {
										  $avatar_image = 'Profile-icon.jpg';
										}
										echo $avatar_image; ?> " class="img-radius" alt="User-Profile-Image">
                                        <span><?php
										$locNm = get_client_name($mycon, $userdata['client_id']);
										if ($locNm != '') {
										  $locName = $locNm;
										...
										echo "<strong>" . $userdata['name'] . " - </strong>" . $userdata['department'] . " <strong> @ " . $locName."</strong>";
										?>   </span>
                                    ...
                                    <ul class="show-notification profile-notification dropdown-menu" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                        ...
                                        <li>
                                            <a href="chanage-password.php"><i class="fa fa-key "></i>Change Password</a>
                                        </li>
                                        <li>
                                            <a href="profile-setting.php"><i class="fa fa-cog "></i>Profile Setting</a>
                                        </li>
										<?php if($userRole == 1 || $userRole == 2 || $userRole == 28 || $userRole == 29){ ?>
                                        <li>
                                            <a href="userlist.php"><i class="fa fa-users "></i>User List</a>
                                        </li>
										<li>
                                            <a href="create-new-user.php">
                                                <i class="icon-user-follow"></i> Create an Account
                                            </a>
                                        </li>
										<?php } ?>
                                        <li>
