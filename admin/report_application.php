...
if ($_POST['department'] == 'department') {
  ...
  $objPHPExcel->getActiveSheet()->getCell('A1')->setValue("Application Report");
 ...
 /*  $objPHPExcel->getActiveSheet()->getStyle(
  ...
  $objPHPExcel->getActiveSheet()->setCellValue('A7', 'HMDS id');
  $objPHPExcel->getActiveSheet()->setCellValue('B7', 'Application id');
  $objPHPExcel->getActiveSheet()->setCellValue('C7', 'Client Code');
  $objPHPExcel->getActiveSheet()->setCellValue('D7', 'Applicant Name');
  $objPHPExcel->getActiveSheet()->setCellValue('E7', 'Types of Checks');
  $objPHPExcel->getActiveSheet()->setCellValue('F7', 'Case id');
  $objPHPExcel->getActiveSheet()->setCellValue('G7', 'Case Record date');
 ...
 //$objPHPExcel->getDefaultStyle()->applyFromArray($styleArray);
  ...
  $objPHPExcel->getActiveSheet()->getStyle('A7:G7')->applyFromArray($styleArray1);
  $objPHPExcel->getActiveSheet()->getStyle('A7:G7')->applyFromArray($styleArray);
  $objPHPExcel->getActiveSheet()->getStyle('A7:G7')->applyFromArray($style_cell);
  $objPHPExcel->getActiveSheet()->getStyle('A7:G7')->getAlignment()->setWrapText(true);
  $objPHPExcel->getActiveSheet()->getRowDimension(11)->setRowHeight(-1);

//$objPHPExcel->getActiveSheet()->getColumnDimension('A7:G7')->setAutoSize(true);
...
$objPHPExcel->getActiveSheet()->getStyle('B3')->getFill()->getStartColor()->setARGB('FFFF0000'); */
  ...
  $file = "Application Report-" .$dated. ".xlsx";
