                        ...
                        <div class="step-app">
                           <ul class="step-steps">
                              ...
                              <li  <?php echo is_visble_verification_tab(16, $type_of_verification_array); ?>><a href="socal_security_number.php">Social Security Number (SSN) Verification</a></li>
                               ...
                               <li  class="active" <?php echo is_visble_verification_tab(20, $type_of_verification_array); ?>><a href="company_verifaction.php">Company Verification</a></li>
                           </ul>
                                 ...
                                 <div class="row">
                                    ...
                                    <?php $sql= "select * from employee_company_verifaction where application_id =  '".$app_id."'";
                                     ...
                                     ?>
                                       <div class="form-group">
                                          ...
                                          <div>
                                             <input type="text" autocomplete="off" name="company_name" id="company_name" value="<?php echo $row24['company_name']; ?>" placeholder="Enter Company Name" data-required="1" class="form-control" required="">
                                          </div>
                                       </div>
                                       <div class="form-group">
                                          <label class="control-label input_hdr">Company Address</label>
                                          <div><input type="text" autocomplete="off" name="company_add" id="company_add" value="<?php echo $row24['company_address']; ?>" placeholder="Enter Company Address" data-required="1" class="form-control"></div>
                                       </div>
                                       <div class="form-group">
                                          <label class="control-label input_hdr">Contact No</label>
                                          <div>
                                             <input type="number" autocomplete="off" name="phone" id="phone" placeholder="Enter Phone Number" value="<?php echo $row24['contact_no']; ?>" data-required="1" class="form-control">
                                          </div>
                                       </div>
                                       <div class="form-group">
                                          <label class="control-label  input_hdr">Contact Person Number </label>
                                          <div>
                                             <input type="number" autocomplete="off" name="contact_person_no" id="contact_person_no" value="<?php echo $row24['contact_person_no']; ?>" data-required="1" placeholder="Enter Contact Person Number" class="form-control">
                                          </div>
                                       </div>
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div>
                                             <input type="email" autocomplete="off" value="<?php echo $row24['company_email']; ?>" name="email" id="email" placeholder="Enter Email" data-required="1" class="form-control">
                                          </div>
                                       </div>
                                       <div class="form-group">
                                          <label class="control-label input_hdr">Company Location</label>
                                          <div>
                                             <input type="text" autocomplete="off" name="company_location" id="company_location" value="<?php echo $row24['company_location']; ?>" placeholder="Company Location" data-required="1" class="form-control">
                                          </div>
                                       </div>
