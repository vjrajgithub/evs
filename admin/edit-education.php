...
<!-- 
              ...
              <div id="demo">
                <div class="step-app">
                  <ul class="step-steps">
                    ...
                    <li <?php echo is_visble_verification_tab(4, $type_of_verification_array); ?>  class="active"><a href="edit-education.php?appid=<?php echo $app_id; ?>">Educational Details</a></li>
 ...
 <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <h6 <?php echo ($appInformation['eduData']['0']['is_completed'] != '1') ? "style='color:red'" : "style='color:green'" ?> ><?php echo $appInformation['eduData']['0']['review_comment']; ?></h6>
                                  </div>
                              ...
                              <section id="section2">
                                ...
                                <article>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div>
                                      <input minlength="4" maxlength="4" type="Number" name="intermediate_passing_year" value="<?php echo $appInformation['eduData']['1']['passing_year'] ?>" id="intermediate_passing_year" data-required="1" class="form-control">
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <label class="control-label">Board / University
...
<!-- verification inter -->
                                  ...
                                  <div class="form-group">
                                    <label class="input_hdr" for="">Review Remark:* </label>
                                    <h6 <?php echo ($appInformation['eduData']['1']['is_completed'] != '1') ? "style='color:red'" : "style='color:green'" ?> ><?php echo $appInformation['eduData']['1']['review_comment']; ?></h6>
                                  </div>
                                  <div class="form-group">
                                           <label class="input_hdr" for="select">Verification Mode</label>
                              ...
                              <section id="section3">
                                ...
                                <article>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div>
                                      <input type="number" name="graduation_roll_no" value="<?php echo $appInformation['eduData']['2']['roll_no'] ?>" id="graduation_roll_no" data-required="1" class="form-control">
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <label class="control-label">Year Of passing
                                    ...
                                    <div>
                                      <input minlength="4" maxlength="4" type="number" name="graduation_passing_year" value="<?php echo $appInformation['eduData']['2']['passing_year'] ?>" id="graduation_passing_year" data-required="1" class="form-control">
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <label class="control-label">Board / University
                                  ...
                                  <div class="form-group">
                                    <label class="input_hdr" for="">Review Remark:*</label>
                                    <h6 <?php echo ($appInformation['eduData']['2']['is_completed'] != '1') ? "style='color:red'" : "style='color:green'" ?> ><?php echo $appInformation['eduData']['2']['review_comment']; ?></h6>
                                  </div>
                                  <!---Start upload documents code--->
                                  <br/><br /><p style="color:#c51b1b;">Upload Documents</p>
                                  <div class="form-group">
                              ...
                              <section id="section4">
                                ...
                                <article>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div>
                                      <input minlength="4" maxlength="4" type="Number" name="post_graduation_passing_year" value="<?php echo $appInformation['eduData']['3']['passing_year'] ?>" id="post_graduation_passing_year" data-required="1" class="form-control">
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <label class="control-label">Board / University
                                  ...
                                  <div class="form-group">
                                    ...
                                    <h6 <?php echo ($appInformation['eduData']['3']['is_completed'] != '1') ? "style='color:red'" : "style='color:green'" ?> ><?php echo $appInformation['eduData']['3']['review_comment']; ?></h6>
                                  </div>
                                  <!---Start upload documents code--->
                                  <br/><br /><p style="color:#c51b1b;">Upload Documents</p>
                                  <div class="form-group">
                              ...
                              <section id="section5">
                                ...
                                <article>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div>
                                      <input type="Number" name="diploma_roll_no" value="<?php echo $appInformation['eduData']['4']['roll_no'] ?>"  id="diploma_roll_no" data-required="1" class="form-control">
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <label class="control-label">Year Of passing
                                    ...
                                    <div>
                                      <input minlength="4" maxlength="4" type="Number" name="diploma_passing_year" value="<?php echo $appInformation['eduData']['4']['passing_year'] ?>"  id="diploma_passing_year" data-required="1" class="form-control">
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <label class="control-label">Board / University
                                    ...
                                    <div>
                                      <input type="Text" name="diploma_board" value="<?php echo $appInformation['eduData']['4']['university_board'] ?>"  id="diploma_board" data-required="1" class="form-control">
                                    </div>
                                  </div>
                                  <div class="form-group">
                                           <label class="input_hdr" for="select">Verification Mode</label>
                                  ...
                                  <div class="form-group">
                                    <label class="input_hdr" for="">Review Remark:* </label>
                                    <h6 <?php echo ($appInformation['eduData']['4']['is_completed'] != '1') ? "style='color:red'" : "style='color:green'" ?> ><?php echo $appInformation['eduData']['4']['review_comment']; ?></h6>
                                  </div>
