                        ...
                        <div class="step-app">
                           <ul class="step-steps">
                              ...
                              <li <?php echo is_visble_verification_tab(10, $type_of_verification_array); ?>><a href="cibil.php">CIBIL Details</a></li>
                               ...
                               <li class="active" <?php echo is_visble_verification_tab(12, $type_of_verification_array); ?>><a href="drug_test.php">Drug Test Screening</a></li>
                           ...
                           <div class="step-tab-panel" id="tab2">
                              ...
                              <form method="post" id="frmInfo_drug" enctype="multipart/form-data">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6">
                                    <?php $sql= "select * from employee_drug_test where application_id =  '".$app_id."'";
                                             $result = mysqli_query($mycon, $sql);
                                     ...
                                     ?>
                                       ...
                                       <div class="form-group">
                                          ...
                                          <div>
                                             ...
                                             <?php $sql_querycheck = "SELECT * FROM type_of_panel WHERE status = 1";
