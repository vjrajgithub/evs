        ...
        <div class="main-body">
            <div class="page-wrapper">
                <div class="page-body">
                    ...
                    <li class="active" <?php echo is_visble_verification_tab(15, $type_of_verification_array); ?>><a href="edit-global_base_check.php?appid=<?php echo $app_id; ?>">Global data base check</a></li>
                    ...
                    <li <?php echo is_visble_verification_tab(20, $type_of_verification_array); ?>><a href="edit-company_verifaction.php?appid=<?php echo $app_id; ?>">Company Verification</a></li>
                                    ...
                                    <div class="step-tab-panel" id="tab2">
                                        ...
                                        <form method="post" id="frmInfo_gbc" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <?php $sql = "select * from employee_global_base_check where application_id =  '" . $app_id . "'";
                                       ...
                                       <span aria-required="true" class="required"> * </span></label>  -->
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <h6 <?php echo ($appInformation['globalBaseData'][0]['is_completed'] != '1') ? "style='color:red'" : "style='color:green'" ?>><?php echo $appInformation['globalBaseData']['0']['review_comment']; ?></h6>
                                                    </div>
                                                </div>
