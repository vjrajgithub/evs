                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                          ...
                          <tbody>
                            ...
                            foreach ($allData as $application) {
                              ...
                              if ($application['application_status'] == '8' || $application['application_status'] == '9' || $application['application_status'] == '10') {
                            ?>
                                ...
                                <tr style="display: table-row;">
                                  ...
                                  <td>
                                    ...
                                    <!-- <button class="btn btn-success" onclick="set_for_approval_form('<?php echo $application['application_ref_id']; ?>');" data-toggle="modal" data-target="#revertUpdationModal" >Quality Check <i  aria-hidden="true"></i>
</button> -->


                                    <?php //if ($userRole == 13) { ?>
                                      <!-- <a title="Quality Check" href="<?php // echo baseUrl() . "verification-report-sheet-print_qc.php?appid=" . $application['application_ref_id'] 
                                                                          ?>" target="_blank" style="color:blue;"><i class="fa fa-check" aria-hidden="true" data-toggle="modal" data-target="#"></i></a> -->


                                      <a title="Quality Check" onclick="set_for_approval_form('<?php echo $application['application_ref_id']; ?>');" style="color:blue;"><i class="fa fa-check" aria-hidden="true" data-toggle="modal" data-target="#revertUpdationModal"></i></a>


                                      <a title="View and QC" href="<?php echo baseUrl() . "verification-report-sheet-print_qc.php?appid=" . $application['application_ref_id'] ?>" target="_blank" style="color:green;"><i class="fa fa-check" aria-hidden="true" data-toggle="modal" data-target="#"></i></a>
                                    <?php //} ?>
...
?>
  ...
  <div id="view_modal_qc" class="modal fade bd-example-modal-lg<?php echo $application['hmds_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        ...
                        <!-- <button type="button" class="btn btn-success" onclick="set_for_approval_form('<?php echo $application['ApplicationDataCheck']['0']['id']; ?>');" data-toggle="modal" data-target="#revertUpdationModal"> Quality Check <i class="fa fa-plus-circle" aria-hidden="true"></i> 
                        </button> -->

                        <!-- <a href="#"><button class="btn btn-success" onclick="set_for_approval_form('<?php echo $application['ApplicationDataCheck']['0']['id']; ?>');" data-toggle="modal" data-target="#revertUpdationModal" >Quality Check <i  aria-hidden="true"></i>
                </button>
              </a> -->
