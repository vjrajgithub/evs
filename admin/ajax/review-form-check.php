...
if (isset($_POST['form_type']) && $_POST['form_type'] == 'application') {
  ...
  if (mysqli_query($mycon, $sql) && mysqli_query($mycon, $sqlCheck)) {
...
if (isset($_POST['form_type']) && $_POST['form_type'] == 'employer') {
  //pre($_POST);
  if (updateFormComment("employee_employment_info_tbl_check", "application_id", "id", $_POST['id1'], $_POST['review_comment1'], $_POST['is_completed1']) && updateFormComment("employee_employment_info_tbl_check", "application_id", "id", $_POST['id2'], $_POST['review_comment2'], $_POST['is_completed2']) && updateFormComment("employee_employment_info_tbl_check", "application_id", "id", $_POST['id3'], $_POST['review_comment3'], $_POST['is_completed3'])) {
    $json = array("status" => 1, "msg" => "Data Submitted Sucessfully");
  } else {
...
if (isset($_POST['form_type']) && $_POST['form_type'] == 'personal') {
  //pre($_POST);
  if (updateFormComment("employee_personal_info_tbl_check", "application_id", "id", $_POST['id'], $_POST['review_comment'], $_POST['is_completed'])) {
    $json = array("status" => 1, "msg" => "Data Submitted Sucessfully");
  } else {
...
if (isset($_POST['form_type']) && $_POST['form_type'] == 'bank') {
  ...
  if (updateFormComment("bank_statement_info_check", "application_id", "id", $_POST['id'], $_POST['review_comment'], $_POST['is_completed'])) {
    $json = array("status" => 1, "msg" => "Data Submitted Sucessfully");
  } else {
    $json = array("status" => 0, "msg" => "Server Error");
  }
...
//  pre($_POST);
  ...
  if (updateFormComment("employee_cibil_check", "application_id", "id", $_POST['id'], $_POST['review_comment'], $_POST['is_completed'])) {
    $json = array("status" => 1, "msg" => "Data Submitted Sucessfully");
  } else {
    $json = array("status" => 0, "msg" => "Server Error");
  }
...
if (isset($_POST['form_type']) && $_POST['form_type'] == 'court') {
  if (updateFormComment("employee_court_record_check", "application_id", "id", $_POST['id'], $_POST['review_comment'], $_POST['is_completed'])) {
    $json = array("status" => 1, "msg" => "Data Submitted Sucessfully");
  } else {
    $json = array("status" => 0, "msg" => "Server Error");
  }
...
//  pre($_POST);
  ...
  if (updateFormComment("drug_abuse_test_check", "application_id", "id", $_POST['id'], $_POST['review_comment'], $_POST['is_completed'])) {
    $json = array("status" => 1, "msg" => "Data Submitted Sucessfully");
  } else {
    $json = array("status" => 0, "msg" => "Server Error");
  }
...
if (isset($_POST['form_type']) && $_POST['form_type'] == 'identity') {
  //pre($_POST);
  if (updateFormComment("employee_identity_verif_tbl_check", "application_id", "id", $_POST['id'], $_POST['review_comment'], $_POST['is_completed'])) {
    $json = array("status" => 1, "msg" => "Data Submitted Sucessfully");
  } else {
...
if (isset($_POST['form_type']) && $_POST['form_type'] == 'gcb') {
  //pre($_POST);
  if (updateFormComment("employee_global_base_check_tbl_check", "application_id", "id", $_POST['id'], $_POST['review_comment'], $_POST['is_completed'])) {
    $json = array("status" => 1, "msg" => "Data Submitted Sucessfully");
  } else {
...
if (isset($_POST['form_type']) && $_POST['form_type'] == 'ssn') {
  //pre($_POST);
  if (updateFormComment("employee_socal_security_number_tbl_check", "application_id", "id", $_POST['id'], $_POST['review_comment'], $_POST['is_completed'])) {
    $json = array("status" => 1, "msg" => "Data Submitted Sucessfully");
  } else {
...
if (isset($_POST['form_type']) && $_POST['form_type'] == 'criminal') {
  //pre($_POST);
  if (updateFormComment("employee_criminal_background_tbl_check", "application_id", "id", $_POST['id'], $_POST['review_comment'], $_POST['is_completed'])) {
    $json = array("status" => 1, "msg" => "Data Submitted Sucessfully");
  } else {
...
if (isset($_POST['form_type']) && $_POST['form_type'] == 'gs') {
  //pre($_POST);
  if (updateFormComment("employee_global_sanctions_tbl_check", "application_id", "id", $_POST['id'], $_POST['review_comment'], $_POST['is_completed'])) {
    $json = array("status" => 1, "msg" => "Data Submitted Sucessfully");
  } else {
...
if (isset($_POST['form_type']) && $_POST['form_type'] == 'nsr') {
  //pre($_POST);
  if (updateFormComment("employee_national_sex_registry_tbl_check", "application_id", "id", $_POST['id'], $_POST['review_comment'], $_POST['is_completed'])) {
    $json = array("status" => 1, "msg" => "Data Submitted Sucessfully");
  } else {
...
if (isset($_POST['form_type']) && $_POST['form_type'] == 'comp_verif') {
  //pre($_POST);
  if (updateFormComment("employee_company_verifaction_tbl_check", "application_id", "id", $_POST['id'], $_POST['review_comment'], $_POST['is_completed'])) {
    $json = array("status" => 1, "msg" => "Data Submitted Sucessfully");
  } else {
...
if (isset($_POST['form_type']) && $_POST['form_type'] == 'court_verif') {
  //pre($_POST);
  if (updateFormComment("employee_court_record_check", "application_id", "id", $_POST['id'], $_POST['review_comment'], $_POST['is_completed'])) {
    $json = array("status" => 1, "msg" => "Data Submitted Sucessfully");
  } else {
...
if (isset($_POST['form_type']) && $_POST['form_type'] == 'drug_verif') {
  //pre($_POST);
  if (updateFormComment("drug_abuse_test_check", "application_id", "id", $_POST['id'], $_POST['review_comment'], $_POST['is_completed'])) {
    $json = array("status" => 1, "msg" => "Data Submitted Sucessfully");
  } else {
...
if (isset($_POST['form_type']) && $_POST['form_type'] == 'address') {
  ...
  if (updateFormComment("employee_address_check", "application_id", "id", $_POST['id1'], $_POST['review_comment1'], $_POST['is_completed1']) && updateFormComment("employee_address_check", "application_id", "id", $_POST['id2'], $_POST['review_comment2'], $_POST['is_completed2'])) {
    $json = array("status" => 1, "msg" => "Data Submitted Sucessfully");
  } else {
...
if (isset($_POST['form_type']) && $_POST['form_type'] == 'education') {
  ...
  if (
          updateFormComment("employee_education_tbl_check", "application_id", "id", $_POST['id1'], $_POST['review_comment1'], $_POST['is_completed1']) && updateFormComment("employee_education_tbl_check", "application_id", "id", $_POST['id2'], $_POST['review_comment2'], $_POST['is_completed2']) && updateFormComment("employee_education_tbl_check", "application_id", "id", $_POST['id3'], $_POST['review_comment3'], $_POST['is_completed3']) && updateFormComment("employee_education_tbl_check", "application_id", "id", $_POST['id4'], $_POST['review_comment4'], $_POST['is_completed4']) && updateFormComment("employee_education_tbl_check", "application_id", "id", $_POST['id5'], $_POST['review_comment5'], $_POST['is_completed5'])
  ) {
    $json = array("status" => 1, "msg" => "Data Submitted Sucessfully");
  } else {
...
if (isset($_POST['form_type']) && $_POST['form_type'] == 'reference') {
  ...
  if (
          updateFormComment("employee_reference_check", "application_id", "id", $_POST['id1'], $_POST['review_comment1'], $_POST['is_completed1']) && updateFormComment("employee_reference_check", "application_id", "id", $_POST['id2'], $_POST['review_comment2'], $_POST['is_completed2']) && updateFormComment("employee_reference_check", "application_id", "id", $_POST['id3'], $_POST['review_comment3'], $_POST['is_completed3']) && updateFormComment("employee_reference_check", "application_id", "id", $_POST['id4'], $_POST['review_comment4'], $_POST['is_completed4'])
  ) {
    $json = array("status" => 1, "msg" => "Data Submitted Sucessfully");
  } else {
...
if (isset($_POST['form_type']) && $_POST['form_type'] == 'verification') {
  if (updateFormComment("employee_police_verification_check", "application_id", "id", $_POST['id'], $_POST['review_comment'], $_POST['is_completed'])) {
    $json = array("status" => 1, "msg" => "Data Submitted Sucessfully");
  } else {
