        ...
        <div class="main-body">
            <div class="page-wrapper">
                <div class="page-body">
                    ...
                    <li class="active" <?php echo is_visble_verification_tab(5, $type_of_verification_array); ?>><a href="edit-identity_verif.php?appid=<?php echo $app_id; ?>">Identity Verification</a></li>
                    ...
                    <li <?php echo is_visble_verification_tab(20, $type_of_verification_array); ?>><a href="edit-company_verifaction.php?appid=<?php echo $app_id; ?>">Company Verification</a></li>
                                    ...
                                    <div class="step-tab-panel" id="tab2">
                                        <h3 class="employer_one">Identity Verify</h3>
                                        <!--<form method="post" id="personalForm" enctype="multipart/form-data">-->
                                        <form method="post" id="frmInfo_identity_verif" enctype="multipart/form-data">
                                            <input type="hidden" name="form_type" value="identity_verif">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <?php $sql = "select * from employee_identity_verif where application_id =  '" . $app_id . "'";
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div>
                                                            <input type="text" name="fathername" value="<?php echo $appInformation['personalData']['0']['fatherName'] ?>" id="fathername" placeholder="Enter Middle Name" data-required="1" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="input_hdr" for="select">Type of Identity</label>
                                                        <select name="identity_type_doc" class="form-control">
                                       ...
                                       <span aria-required="true" class="required"> * </span></label>  -->
                                                        <div><input type="text" name="identity_doc_desc" data-required="1" class="form-control" placeholder="Please enter Document no."></div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div>
                                                            <input type="file" name="identity_doc[]" id="passport_photo" aria-describedby="" class="form-control" style="width: 220px;" multiple>
                                                        </div>
                                                    </div>
                                                    <!---End upload documents code--->
                                                    <div class="form-group">
                                                        <label class="input_hdr" for="">Review Remark:* </label>
                                                        <h6 <?php echo ($appInformation['identityData'][0]['is_completed'] != '1') ? "style='color:red'" : "style='color:green'" ?>><?php echo $appInformation['identityData']['0']['review_comment']; ?></h6>
                                                    </div>
                                                </div>
