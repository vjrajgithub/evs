        ...
        <div class="main-body">
            <div class="page-wrapper">
                <div class="page-body">
                    ...
                    <li class="active" <?php echo is_visble_verification_tab(20, $type_of_verification_array); ?>><a href="edit-company_verifaction.php?appid=<?php echo $app_id; ?>">Company Verification</a></li>
                                    </ul>
                                    ...
                                    <div class="col-md-6">
                                    <?php $sql= "select * from employee_company_verifaction where application_id =  '".$app_id."'";
                                             $result = mysqli_query($mycon, $sql);
                                            $row24= mysqli_fetch_assoc($result);
                                          //   echo  $sql ; //die('dfgdgdf');
                                     ?>
                                       <div class="form-group">
                                          <label class="control-label input_hdr">Company Name</label>
                                          <div>
                                             <input type="text" name="company_name" id="company_name" value="<?php echo $row24['company_name']; ?>" placeholder="Enter Company Name" data-required="1" class="form-control" required="">
                                          </div>
                                       </div>
                                       <div class="form-group">
                                          <label class="control-label input_hdr">Company Address</label>
                                          <div><input type="text" name="company_add" id="company_add" value="<?php echo $row24['company_address']; ?>" placeholder="Enter Company Address" data-required="1" class="form-control"></div>
                                       </div>
                                       <div class="form-group">
                                          <label class="control-label input_hdr">Contact No</label>
                                          <div>
                                             <input type="number" name="phone" id="phone" placeholder="Enter Phone Number" value="<?php echo $row24['contact_no']; ?>" data-required="1" class="form-control">
                                          </div>
                                       </div>
                                       <div class="form-group">
                                          <label class="control-label  input_hdr">Contact Person Number </label>
                                          <div>
                                             <input type="number" name="contact_person_no" id="contact_person_no" value="<?php echo $row24['contact_person_no']; ?>" data-required="1" placeholder="Enter Contact Person Number" class="form-control">
                                          </div>
                                       </div>
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          <label class="control-label input_hdr">Company Email</label>
                                          <div>
                                             <input type="email" value="<?php echo $row24['company_email']; ?>" name="email" id="email" placeholder="Enter Email" data-required="1" class="form-control">
                                          </div>
                                       </div>
                                       <div class="form-group">
                                          <label class="control-label input_hdr">Company Location</label>
                                          <div>
                                             <input type="text" name="company_location" id="company_location" value="<?php echo $row24['company_location']; ?>" placeholder="Company Location" data-required="1" class="form-control">
                                          </div>
                                       </div>
                                       ...
                                       <div class="form-group">
                                                        ...
                                                        <h6 <?php echo ($appInformation['compVerifData'][0]['is_completed'] != '1') ? "style='color:red'" : "style='color:green'" ?>><?php echo $appInformation['compVerifData']['0']['review_comment']; ?></h6>
                                                    </div>
                                    </div>
