                     ...
                     <div id="demo">
                        <div class="step-app">
                           <ul class="step-steps">
                              ...
                              <li class="active"><a href="edit-personal.php?appid=<?php echo $app_id; ?>">Personal Details</a></li>
                                    ...
                                    <div class="col-md-6">
                                       ...
                                       <div class="form-group eligibility_ind"><label class=" input_hdr check_box">Are you legally eligible for employment in the India?
                                          ...
                                          <label class="radio  input_hdr">
                                             <input <?php if ($appInformation['personalData']['0']['is_are_you_legally_eligible_for_employment_in_the_india'] == 1) echo  "checked='checked'"; ?> type="radio" name="is_eligible" value="1"> <span>Yes</span>
                                          </label>
                                          <label class="radio  input_hdr">
                                             <input <?php if ($appInformation['personalData']['0']['is_are_you_legally_eligible_for_employment_in_the_india'] == 2) echo "checked='checked'"; ?> type="radio" name="is_eligible" value="2"> <span>No</span>
                                          </label>
                                          <label class="radio  input_hdr">
                                             <input <?php if ($appInformation['personalData']['0']['is_are_you_legally_eligible_for_employment_in_the_india'] == 0) echo "checked='checked'"; ?> type="radio" name="is_eligible" value=""> <span>NA</span>
                                          </label>
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                       ...
                                       <div class="form-group">
                                          ...
                                          <div>
                                             <input type="text" name="fathername" value="<?php echo $appInformation['personalData']['0']['fatherName'] ?>" id="middlename" placeholder="Enter Middle Name" data-required="1" class="form-control">
                                          </div>
                                       </div>
                                       <div class="form-group">
                                       ...
                                       <div class="form-group eligibility_ind"><label class=" input_hdr check_box">Your Gender
                                          ...
                                          <label class="radio  input_hdr"><input <?php if ($appInformation['personalData']['0']['gender'] == 1) echo "checked='checked'"; ?> type="radio" name="gender" value="1" checked="checked"> <span>Male</span></label>
                                          <label class="radio  input_hdr"><input <?php if ($appInformation['personalData']['0']['gender'] == 2) echo "checked='checked'"; ?> type="radio" name="gender" value="2"> <span>Female</span></label>
                                       </div>
                                       <div class="form-group">
                                       ...
                                       <div class="form-group">
                                          ...
                                          <h6 <?php echo ($appInformation['personalData'][0]['is_completed'] != '1') ? "style='color:red'" : "style='color:green'" ?>><?php echo $appInformation['personalData']['0']['review_comment']; ?></h6>
                                       </div>
                                    </div>
