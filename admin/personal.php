               ...
               <div class="card">
                  <div class="card-block application_dtls">
                     <div id="demo">
                        <div class="step-app">
                           <ul class="step-steps">
                              <li ><a href="add-new-applications.php" id="add_new_app" >Application Details</a></li>
                              <li class="active"><a href="personal.php" id="per_detail_link">Personal Details</a></li>
                           ...
                           <div class="step-tab-panel" id="tab2">
                              ...
                              <form method="post" id="frmInfo" enctype="multipart/form-data">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6">
                                    <?php $sql= "select * from employee_personal_info_tbl where application_id =  '".$app_id."'";
                                             $result = mysqli_query($mycon, $sql);
                                     ...
                                     ?>
                                       <div class="form-group">
                                          ...
                                          <div>
                                             <input type="text" name="firstname" id="firstname" value="<?php echo $row24['firstName']; ?>" placeholder="Enter First Name" data-required="1" class="form-control">
                                          </div>
                                       </div>
                                       <div class="form-group">
                                          <label class="control-label input_hdr">Last Name</label>
                                          <div><input type="text" name="lastname" id="lastname" value="<?php echo $row24['lastName']; ?>" placeholder="Enter Last Name" data-required="1" class="form-control"></div>
                                       </div>
                                       <div class="form-group">
                                          <label class="control-label input_hdr">Phone Number</label>
                                          <div>
                                             <input type="number" name="phone" id="phone" placeholder="Enter Phone Number" value="<?php echo $row24['phoneNo']; ?>" data-required="1" class="form-control">
                                          </div>
                                       </div>
                                       <div class="form-group">
                                          <label class="control-label  input_hdr">Alternate Contact Number </label>
                                          <div>
                                             <input type="number" name="alternate_contact_no" id="alternate_contact_no" value="<?php echo $row24['alternateContact']; ?>" data-required="1" placeholder="Enter Alternate Contact Number" class="form-control">
                                          </div>
                                       </div>
                                       <div class="form-group eligibility_ind"><label class=" input_hdr check_box">Are you legally eligible for employment?
                                             <span aria-required="true" class="required"> * </span></label><br />
                                          <label class="radio  input_hdr">
                                             <input <?php if($row24['is_are_you_legally_eligible_for_employment_in_the_india'] == 1  ) echo "checked='checked'"; ?>  type="radio" name="is_eligible" value="1"> <span>Yes</span>
                                          </label>
                                          <label class="radio  input_hdr">
                                             <input <?php if($row24['is_are_you_legally_eligible_for_employment_in_the_india'] == 2  ) echo "checked='checked'"; ?> type="radio" name="is_eligible" value="2"> <span>No</span>
                                          </label>
                                          <label class="radio  input_hdr">
                                             <input <?php if($row24['is_are_you_legally_eligible_for_employment_in_the_india'] == 0  ) echo "checked='checked'"; ?> type="radio" name="is_eligible" value="" > <span>NA</span>
                                          </label>
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div>
                                             <input type="text" value="<?php echo $row24['middleName']; ?>" name="middlename" id="middlename" placeholder="Enter Middle Name" data-required="1" class="form-control">
                                          </div>
                                       </div>
                                       <div class="form-group">
                                          <label class="control-label input_hdr">Father Name</label>
                                          <div>
                                             <input type="text" name="fathername" id="fathername" value="<?php echo $row24['fatherName']; ?>" placeholder="Father Name" data-required="1" class="form-control">
                                          </div>
                                       </div>
                                       <div class="form-group">
                                          ...
                                          <div>
                                             <input type="date" name="dob" id="dob" aria-describedby="" value="<?php echo $row24['dob']; ?>" placeholder="dd-mm-yyyy" class="form-control" style="width: 220px;">
                                          </div>
                                       </div>
                                       <div class="form-group">
                                          <label class="control-label input_hdr">Email Id </label>
                                          <div>
                                             <input value="<?php echo $row24['email']; ?>" type="email" name="email" id="email" placeholder="Enter Email Address" data-required="1" class="form-control">
                                          </div>
                                       </div>
                                       <div class="form-group eligibility_ind"><label class=" input_hdr check_box">Your Gender
                                             <span aria-required="true" class="required"> * </span></label> <br>
                                          <label class="radio  input_hdr"><input checked="checked" <?php if($row24['gender'] == 1  ) echo "checked='checked'"; else ""; ?> type="radio" name="gender" value="1" > <span>Male</span></label>
                                          <label class="radio  input_hdr"><input  <?php if($row24['gender'] == 2  ) echo "checked='checked'"; ?> type="radio" name="gender" value="2"> <span>Female</span></label>
                                         <label class="radio  input_hdr"><input  <?php if($row24['gender'] == 3  ) echo "checked='checked'"; ?> type="radio" name="gender" value="3"> <span>Other</span></label>
                                       </div>
                                       <div class="form-group">
