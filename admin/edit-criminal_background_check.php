        ...
        <div class="main-body">
            <div class="page-wrapper">
                <div class="page-body">
                    ...
                    <li class="active" <?php echo is_visble_verification_tab(17, $type_of_verification_array); ?>><a href="edit-criminal_background_check.php?appid=<?php echo $app_id; ?>">Criminal background check (Federal and Local)</a></li>
                    ...
                    <li <?php echo is_visble_verification_tab(20, $type_of_verification_array); ?>><a href="edit-company_verifaction.php?appid=<?php echo $app_id; ?>">Company Verification</a></li>
                                    ...
                                    <div class="step-tab-panel" id="tab2">
                                        <h3 class="employer_one">Criminal background check (Federal and Local)</h3>
                                        <!--<form method="post" id="personalForm" enctype="multipart/form-data">-->
                                        <form method="post" id="frmInfo_criminal_back" enctype="multipart/form-data">
                                            <input type="hidden" name="form_type" value="criminal_back">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <?php $sql = "select * from employee_criminal_background where application_id =  '" . $app_id . "'";
                                       ...
                                       <span aria-required="true" class="required"> * </span></label>  -->
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <h6 <?php echo ($appInformation['criminalData'][0]['is_completed'] != '1') ? "style='color:red'" : "style='color:green'" ?>><?php echo $appInformation['criminalData']['0']['review_comment']; ?></h6>
                                                    </div>
                                                </div>
